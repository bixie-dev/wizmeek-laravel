...
$(document).ready(function () {
  ...
  $(document).mouseup(function (e) {
    ...
    if (!div.is(e.target) // if click is not on the div
    && div.has(e.target).length === 0 // and not child elements
    && !user_avatar.is(e.target) && !user_name.is(e.target)) {
      // and not a user buttons
      div.removeClass('active'); // Deleting class "active"
    }
  });
 ...
 var popup_email_btn = $("#email-change");
  var popup_email = $("#email_popup");
  popup_email_btn.click(function() {
    popup_email.toggle(250);
  });
  $(document).mouseup(function (e) {
    if (!popup_email.is(e.target) && popup_email.has(e.target).length === 0) {
      popup_email.hide(250);
    }
  });
  __webpack_require__(/*! ./robots-filter */ "./resources/js/robots-filter.js");
  __webpack_require__(/*! ./feedback */ "./resources/js/feedback.js");
  __webpack_require__(/*! ./emoji-picker */ "./resources/js/emoji-picker.js");
...
if ($('#feedback').length) {
  $('#rating').rating();
  var links = $('.feedback__tab--link');
  var tabs = $('.feedback__tab');
...
if ($('#robots-filter').length) {
  var check = $('#robots-filter-check');
  var input = $('#robots-filter-key-count');
  var key_count = 0;
...
var textarea = document.querySelector('#summernote');
if (textarea) {
  $(textarea).summernote();
}
