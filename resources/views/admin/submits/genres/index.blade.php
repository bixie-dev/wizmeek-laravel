...
@section('main-content')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Genres for submits</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <div class="col-3 mb-3">
        <a href="{{ route('admin.genres.create') }}" class="btn btn-block btn-primary">Add new genre</a>
    </div>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  @foreach($genres as $genre)
                    <tr>
                      <td style="vertical-align: middle">{{ $genre->id }}</td>
                      <td style="vertical-align: middle">{{ $genre->genre }}</td>
                      <td class="d-flex" style="flex:shrink; vertical-align:middle;">
                        <a class="mr-3" href="{{ route('admin.genres.show', $genre->id) }}" style="padding: 21px 0px;">
                        ...
                        <a class="mr-3" href="{{ route('admin.genres.edit', $genre->id) }}" style="padding: 21px 0px;">
                        ...
                        <form action="{{ route('admin.genres.destroy', $genre->id) }}" method="post" style="padding: 21px 0px;">
                          @csrf
                          @method('delete')
