    ...
    <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Submits</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <?php $genres = $submit->genre()->get() ?>
                    <tr>
                      <td style="vertical-align: middle">{{ $submit->artist_name }}</td>
                      <td style="vertical-align: middle">{{ $submit->song_title }}</td>
                      <td style="vertical-align: middle">{{ $submit->user ? $submit->user->name : "User was deleted" }}</td>
                      <td style="vertical-align: middle">{{ $submit->release_date }}</td>
                      ...
                      <td class="d-flex" style="flex:shrink; vertical-align:middle;">
                        <a class="mr-3" href="{{ route('admin.submits.show', $submit->id) }}" style="padding: 21px 0px;">
                        ...
                        <form action="{{ route('admin.submits.destroy', $submit->id) }}" method="post" style="padding: 21px 0px;">
                          @csrf
                          @method('delete')
